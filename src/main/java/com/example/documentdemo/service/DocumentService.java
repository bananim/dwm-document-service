...
public interface DocumentService {
	 ...
	 * @throws SQLException 
	 */
	public void addDocuments(MultipartFile[] multipartFiles, String userName) throws FileStorageException, DocumentAlreadyExistsException;
	public Document updateDocument(String newName, Long id, MultipartFile fileToUpdate) throws FileStorageException, DocumentNotFoundException;
